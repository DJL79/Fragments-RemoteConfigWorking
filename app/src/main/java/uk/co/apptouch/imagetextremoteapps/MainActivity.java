...
public class MainActivity extends AppCompatActivity
    ...
    private static final String TEXTVIEW_CONTENT = "remotedata_one";
    private static final String TEXTVIEW_CONTENT2 = "remotedata_two";
    private static final String IMAGE_URL_LINK = "image_url";
    private FirebaseRemoteConfig mFirebaseRemoteConfig;
    String remotedataone,remotedatatwo;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            b1.putString("remoteconfigdata", remotedataone);
            ...
            b2.putString("remoteconfigdata", remotedatatwo);
    ...
    public void displayWelcomeMessage() {
        this.remotedataone = mFirebaseRemoteConfig.getString(TEXTVIEW_CONTENT);
        this.remotedatatwo = mFirebaseRemoteConfig.getString(TEXTVIEW_CONTENT2);
